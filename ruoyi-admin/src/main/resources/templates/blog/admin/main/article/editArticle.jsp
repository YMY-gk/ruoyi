<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
	...
	<div class="box no-border">
		...
		<!-- form start -->
		<form role="form">
			<div class="box-body" id="articleId" data-id="${article.id}">
				<div class="form-group">
					<label for="exampleInputEmail1">文章标题</label> 
					<input type="text" class="form-control" id="title" value="${article.aTitle}" placeholder="Enter title">
				</div>
				<div class="form-group">
					<label for="exampleInputPassword1">文章标签</label>
					<input type="text" class="form-control" id="tokenfield" value = "${article.aTags}"/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea id="mdContent" type="text" hidden="hidden">${article.aContent }</textarea>
				</div>
			</div>
			<!-- /.box-body -->

			<div class="box-footer">
				<button type="button" id="updateBtn" class="btn btn-success btn-flat">确认修改</button><button type="submit" class="btn btn-danger btn-flat">返回列表</button>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript">
		...
		$("#updateBtn").click(function() {
			...
			$.ajax({
				type : "post",
				url : "${pageContext.request.contextPath}/sys/article/update",
				data : {
					title:title,
					tags : tags,
					type : type,
