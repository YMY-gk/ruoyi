...
public class JobInvokeUtil
{
    ...
    public static void invokeQiartz(JobExecutionContext context) throws Exception {

        JobDetail job = context.getJobDetail();
        SysJob sysJob = (SysJob) job.getJobDataMap().get(ScheduleConstants.TASK_PROPERTIES);
